# ============================================================
# Colonel Blotto — Q-Learning vs Random Agent
# ============================================================
# Trains a tabular Q-Learning agent (player 0) against a random
# opponent (player 1). Mirrors the structure of blotto_rl.py,
# which runs SARSA vs random — this file is the Q-Learning
# counterpart for direct comparison between the two algorithms.
# ============================================================
...
# QLearner: off-policy tabular Q-learning.
#   Q(s,a) ← Q(s,a) + α * [r + γ * max_a' Q(s',a') − Q(s,a)]
# In one-shot Blotto the bootstrap term is 0, so this reduces to:
#   Q(s,a) ← Q(s,a) + α * [r − Q(s,a)]
rl_agent = tabular_qlearner.QLearner(
    player_id=0,
...
plt.plot(episodeArr, y, label = "QL Wins")
plt.plot(x, y, label = "Sarsa vs QL wins" )
...
print("\nWON Games")
print("Q-Learning Agent:", int(won_games[0]))
